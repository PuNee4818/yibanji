...
if(profile){const id=profile.dataset.profileId!;let page=0;const{data:{user}}=await supabase.auth.getUser();const more=document.querySelector<HTMLButtonElement>('[data-profile-more]')!;

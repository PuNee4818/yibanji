-- Administrative debits are ledger adjustments, not egg throws.
...
begin
 ...
 elsif d.metric='spent' then select coalesce(sum(quantity),0) into n from public.egg_throws where user_id=u;
